            ...
            public void run() {
                ...
                while (!scheduleThreadToStop) {
                    ...
                    try {
                        ...
                        List<XxlJobInfo> scheduleList = XxlJobAdminConfig.getAdminConfig().getIgReportJobInfoDao().scheduleJobQuery(nowTime + PRE_READ_MS, preReadCount);
                        if (scheduleList!=null && scheduleList.size()>0) {
                            ...
                            for (XxlJobInfo jobInfo: scheduleList) {
                                XxlJobAdminConfig.getAdminConfig().getIgReportJobInfoDao().scheduleUpdate(jobInfo);
                            }
