package com.lyl.igreport.xxljob.service.impl;
...
import com.lyl.igreport.dao.mysql.XxlJobRegistryDao;
...
public class AdminBizImpl implements AdminBiz {
    ...
    private ReturnT<String> callback(HandleCallbackParam handleCallbackParam) {
        // valid log item
        XxlJobLog log = igReportJobLogDao.load(handleCallbackParam.getLogId());
        if (log == null) {
        ...
        if (IJobHandler.SUCCESS.getCode() == handleCallbackParam.getExecuteResult().getCode()) {
            XxlJobInfo xxlJobInfo = igReportJobInfoDao.loadById(log.getJobId());
